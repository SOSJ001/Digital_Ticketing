                            ...
                            <div style="background-color: rgba(0, 0, 0, 0.5);" class="container p-3 rounded">
                                ...
                                <div class="row truncate align-items-center mb--20">
                                    ...
                                    <div class="col-lg-6 mb-20 mt-3">
                                        <ul class="d-flex row row-col-sm-12">
                                            <li
                                            ...
                                            <li
                                                class="col m-3 rounded-5 d-flex align-items-center justify-content-center">
                                                <span class="pl-1"><i
                                                        class="mx-2 text-warning fa-sharp fa-regular fa-futbol fa-beat"></i>Sports</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-12 col-md-12 col-lg-4 col-sm-12">
                                        <div class="form-group">
                                            <label for="search" class="block text-light font-bold mb-2">Search</label>
                ...
                <div class="row row-col-2 fs-1 text-light p-5 ">
                    ...
                    <div class="col col-md-12 col-sm-12 uppercase">
                        <div class="w-full rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <ul class="p-3 flex flex-wrap text-sm font-medium text-center border-b border-gray-200 rounded-t-lg dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800"
                                id="defaultTab" data-tabs-toggle="#defaultTabContent" role="tablist">
                                <li class="mr-2" role="presentation">
                                    <button
                                        class="active-tab hover:bg-yellow-500 inline-block p-4 border-warning border-2 border rounded-t-lg"
                                        id="trending-tab" data-tabs-target="#TRENDING" type="button" role="tab"
                                        aria-controls="TRENDING" aria-selected="true">TRENDING</button>
                                </li>
                                <li class="mr-2" role="presentation">
                                    <button
                                        class="hover:bg-yellow-500 inline-block p-4 border-warning border-2 border rounded-t-lg"
                            ...
                            <div id="defaultTabContent">
                                <div class="hidden rounded-lg" id="TRENDING" role="tabpanel"
                                    ...
                                    <div class="owl-carousel">
                                        <div class="items">
                                            <div class="shadow rounded image-container">
                                                <a href="#">
                                                    <img class=" rounded"
